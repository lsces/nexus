{strip}
{if $editItem.menu_id}
	<div class="floaticon"><a href="{$smarty.const.PKG_NEXUS_URL}menu_items.php?tab=edit&amp;menu_id={$editItem.menu_id}">{biticon ipackage="icons" iname="view-list-text" ipackage="icons" iexplain="create new menu"}</a></div>
{/if}
